...
import numpy as np
from train_pca import ClassificationModel  
from sklearn.metrics import precision_score, recall_score, f1_score
from sklearn.decomposition import PCA
import random
import joblib

def load_test_data(apply_pca=False, pca_components=100):
    # Load your test data
    ...
    test_combined = np.concatenate((test_visual, test_audio_reduced), axis=2)
...
if __name__ == "__main__":
    ...
    test_loader = load_test_data(apply_pca=True, pca_components=100)
